...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../images/Plot_filtro.png}
    \caption{Sinal 1 Original no Tempo}
\end{figure}

Agora, ao mudarmos os parâmetros $W_c$(Frequência de Corte) e L(\textit{Samples}), vamos ter os seguintes resultados:\\\\
